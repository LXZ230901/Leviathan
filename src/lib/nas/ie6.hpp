...
struct IEQoSFlowDescriptions : InformationElement6
{
    ...
    static void Corrupt(IEQoSFlowDescriptions &ie, const OctetString &bytes);
};
...
struct IEPayloadContainer : InformationElement6
{
    ...
    static void Corrupt(IEPayloadContainer &ie, const OctetString &bytes);
};
...
struct IEExtendedEmergencyNumberList : InformationElement6
{
    ...
    static void Corrupt(IEExtendedEmergencyNumberList &ie, const OctetString &bytes);
};
...
struct IEEpsNasMessageContainer : InformationElement6
{
    ...
    static void Corrupt(IEEpsNasMessageContainer &ie, const OctetString &bytes);
};
...
struct IENasMessageContainer : InformationElement6
{
    ...
    static void Corrupt(IENasMessageContainer &ie, const OctetString &bytes);
};
...
struct IEExtendedProtocolConfigurationOptions : InformationElement6
{
    ...
    static void Corrupt(IEExtendedProtocolConfigurationOptions &ie, const OctetString &bytes);
};
...
struct IEPduSessionReactivationResultErrorCause : InformationElement6
{
    ...
    static void Corrupt(IEPduSessionReactivationResultErrorCause &ie, const OctetString &bytes);
};
...
struct IELadnIndication : InformationElement6
{
    ...
    static void Corrupt(IELadnIndication &ie, const OctetString &bytes);
};
...
struct IELadnInformation : InformationElement6
{
    ...
    static void Corrupt(IELadnInformation &ie, const OctetString &bytes);
};
...
struct IEOperatorDefinedAccessCategoryDefinitions : InformationElement6
{
    ...
    static void Corrupt(IEOperatorDefinedAccessCategoryDefinitions &ie, const OctetString &bytes);
};
...
struct IEMappedEpsBearerContexts : InformationElement6
{
    ...
    static void Corrupt(IEMappedEpsBearerContexts &ie, const OctetString &bytes);
};
...
struct IEQoSRules : InformationElement6
{
    ...
    static void Corrupt(IEQoSRules &ie, const OctetString &bytes);
};
...
struct IESorTransparentContainer : InformationElement6
{
    ...
    static void Corrupt(IESorTransparentContainer &ie, const OctetString &bytes);
};
...
struct IE5gsMobileIdentity : InformationElement6
{
    ...
    static void Corrupt(IE5gsMobileIdentity &ie, const OctetString &bytes);
};
...
struct IEEapMessage : InformationElement6
{
    ...
    static void Corrupt(IEEapMessage &ie, const OctetString &bytes);
};
