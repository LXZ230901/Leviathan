...
struct IE5gMmCause : InformationElement3
{
    ...
    static void Corrupt(IE5gMmCause &ie, const OctetString &bytes);
};
...
struct IE5gsTrackingAreaIdentity : InformationElement3
{
    ...
    static void Corrupt(IE5gsTrackingAreaIdentity &ie, const OctetString &bytes);
};
...
struct IEAuthenticationParameterRand : InformationElement3
{
    ...
    static void Corrupt(IEAuthenticationParameterRand &ie, const OctetString &bytes);
};
...
struct IEEpsNasSecurityAlgorithms : InformationElement3
{
    ...
    static void Corrupt(IEEpsNasSecurityAlgorithms &ie, const OctetString &bytes);
};
...
struct IEGprsTimer : InformationElement3
{
    ...
    static void Corrupt(IEGprsTimer &ie, const OctetString &bytes);
};
...
struct IEIntegrityProtectionMaximumDataRate : InformationElement3
{
    ...
    static void Corrupt(IEIntegrityProtectionMaximumDataRate &ie, const OctetString &bytes);
};
...
struct IEMaximumNumberOfSupportedPacketFilters : InformationElement3
{
    ...
    static void Corrupt(IEMaximumNumberOfSupportedPacketFilters &ie, const OctetString &bytes);
};
...
struct IEN1ModeToS1ModeNasTransparentContainer : InformationElement3
{
    ...
    static void Corrupt(IEN1ModeToS1ModeNasTransparentContainer &ie, const OctetString &bytes);
};
...
struct IENasSecurityAlgorithms : InformationElement3
{
    ...
    static void Corrupt(IENasSecurityAlgorithms &ie, const OctetString &bytes);
};
...
struct IEPduSessionIdentity2 : InformationElement3
{
    ...
    static void Corrupt(IEPduSessionIdentity2 &ie, const OctetString &bytes);
};
...
struct IETimeZone : InformationElement3
{
    ...
    static void Corrupt(IETimeZone &ie, const OctetString &bytes);
};
...
struct IETimeZoneAndTime : InformationElement3
{
    ...
    static void Corrupt(IETimeZoneAndTime &ie, const OctetString &bytes);
};
...
struct IE5gSmCause : InformationElement3
{
    ...
    static void Corrupt(IE5gSmCause &ie, const OctetString &bytes);
};
