...
void IE5gsIdentityType::Corrupt(IE5gsIdentityType &ie, int val)
{
    ie.value = (EIdentityType)(val & 0x7);
}
...
void IE5gsRegistrationType::Corrupt(IE5gsRegistrationType &ie, int val)
{
    ie.followOnRequestPending = (EFollowOnRequest)(val & 0x1);
    ie.registrationType = (ERegistrationType)((val >> 1) & 0x7);
}
...
void IEAccessType::Corrupt(IEAccessType &ie, int val)
{
    ie.value = (EAccessType)(val & 0x3);
}
...
void IEAllowedSscMode::Corrupt(IEAllowedSscMode &ie, int val)
{
    ie.ssc1 = (ESsc1)(val & 0x1);
    ie.ssc2 = (ESsc2)((val >> 1) & 0x1);
    ie.ssc3 = (ESsc3)((val >> 2) & 0x1);
}
...
void IEAlwaysOnPduSessionIndication::Corrupt(IEAlwaysOnPduSessionIndication &ie, int val)
{
    ie.value = (EAlwaysOnPduSessionIndication)(val & 0x1);
}
...
void IEAlwaysOnPduSessionRequested::Corrupt(IEAlwaysOnPduSessionRequested &ie, int val)
{
    ie.value = (EAlwaysOnPduSessionRequested)(val & 0x1);
}
...
void IEConfigurationUpdateIndication::Corrupt(IEConfigurationUpdateIndication &ie, int val)
{
    ie.ack = (EAcknowledgement)(val & 0x1);
    ie.red = (ERegistrationRequested)((val >> 1) & 0x1);
}
...
void IEDeRegistrationType::Corrupt(IEDeRegistrationType &ie, int val)
{
    ie.accessType = (EDeRegistrationAccessType)(val & 0x3);
    ie.reRegistrationRequired = (EReRegistrationRequired)((val >> 2) & 0x1);
    ie.switchOff = (ESwitchOff)((val >> 3) & 0x1);
}
...
void IEImeiSvRequest::Corrupt(IEImeiSvRequest &ie, int val)
{
    ie.imeiSvRequest = (EImeiSvRequest)(val & 0x7);
}
...
void IEMicoIndication::Corrupt(IEMicoIndication &ie, int val)
{
    ie.raai = (ERegistrationAreaAllocationIndication)(val & 0x1);
}
...
void IENasKeySetIdentifier::Corrupt(IENasKeySetIdentifier &ie, int val)
{
    ie.tsc = (ETypeOfSecurityContext)(val & 0x1);
    ie.ksi = (val >> 1) & 0x7;
}
...
void IENetworkSlicingIndication::Corrupt(IENetworkSlicingIndication &ie, int val)
{
    ie.nssci = (ENetworkSlicingSubscriptionChangeIndication)(val & 0x1);
    ie.dcni = (EDefaultConfiguredNssaiIndication)((val >> 1) & 0x1);
}
...
void IENssaiInclusionMode::Corrupt(IENssaiInclusionMode &ie, int val)
{
    ie.nssaiInclusionMode = (ENssaiInclusionMode)(val & 0x3);
}
...
void IEPayloadContainerType::Corrupt(IEPayloadContainerType &ie, int val)
{
    ie.payloadContainerType = (EPayloadContainerType)(val & 0xF);
}
...
void IEPduSessionType::Corrupt(IEPduSessionType &ie, int val)
{
    ie.pduSessionType = (EPduSessionType)(val & 0x7);
}
...
void IERequestType::Corrupt(IERequestType &ie, int val)
{
    ie.requestType = (ERequestType)(val & 0x7);
}
...
void IEServiceType::Corrupt(IEServiceType &ie, int val)
{
    ie.serviceType = (EServiceType)(val & 0xF);
}
...
void IESmsIndication::Corrupt(IESmsIndication &ie, int val)
{
    ie.sai = (ESmsAvailabilityIndication)(val & 0x1);
}
...
void IESscMode::Corrupt(IESscMode &ie, int val)
{
    ie.sscMode = (ESscMode)(val & 0x7);
}
} // namespace nas
