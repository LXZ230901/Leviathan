...
template <typename T>
static void CorruptViaMutator(T &msg, int ieIndex, const OctetString &bytes)
{
    NasMessageMutator mutator{};
    msg.onCorrupt(mutator, ieIndex, bytes);
}

static void CorruptSm(SmMessage &msg, int ieIndex, const OctetString &bytes)
{
    switch (msg.messageType)
    {
    case EMessageType::PDU_SESSION_ESTABLISHMENT_REQUEST:
        CorruptViaMutator((PduSessionEstablishmentRequest &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_ESTABLISHMENT_ACCEPT:
        CorruptViaMutator((PduSessionEstablishmentAccept &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_ESTABLISHMENT_REJECT:
        CorruptViaMutator((PduSessionEstablishmentReject &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_AUTHENTICATION_COMMAND:
        CorruptViaMutator((PduSessionAuthenticationCommand &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_AUTHENTICATION_COMPLETE:
        CorruptViaMutator((PduSessionAuthenticationComplete &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_AUTHENTICATION_RESULT:
        CorruptViaMutator((PduSessionAuthenticationResult &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_MODIFICATION_REQUEST:
        CorruptViaMutator((PduSessionModificationRequest &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_MODIFICATION_REJECT:
        CorruptViaMutator((PduSessionModificationReject &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_MODIFICATION_COMMAND:
        CorruptViaMutator((PduSessionModificationCommand &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_MODIFICATION_COMPLETE:
        CorruptViaMutator((PduSessionModificationComplete &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_MODIFICATION_COMMAND_REJECT:
        CorruptViaMutator((PduSessionModificationCommandReject &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_RELEASE_REQUEST:
        CorruptViaMutator((PduSessionReleaseRequest &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_RELEASE_REJECT:
        CorruptViaMutator((PduSessionReleaseReject &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_RELEASE_COMMAND:
        CorruptViaMutator((PduSessionReleaseCommand &)msg, ieIndex, bytes);
        break;
    case EMessageType::PDU_SESSION_RELEASE_COMPLETE:
        CorruptViaMutator((PduSessionReleaseComplete &)msg, ieIndex, bytes);
        break;
    case EMessageType::FIVEG_SM_STATUS:
        CorruptViaMutator((FiveGSmStatus &)msg, ieIndex, bytes);
        break;
    default:
        throw std::runtime_error("invalid NAS message type");
    }
...
static void CorruptMm(PlainMmMessage &msg, int ieIndex, const OctetString &bytes)
{
    switch (msg.messageType)
    {
    case EMessageType::REGISTRATION_REQUEST:
        CorruptViaMutator((RegistrationRequest &)msg, ieIndex, bytes);
        break;
    case EMessageType::REGISTRATION_ACCEPT:
        CorruptViaMutator((RegistrationAccept &)msg, ieIndex, bytes);
        break;
    case EMessageType::REGISTRATION_COMPLETE:
        CorruptViaMutator((RegistrationComplete &)msg, ieIndex, bytes);
        break;
    case EMessageType::REGISTRATION_REJECT:
        CorruptViaMutator((RegistrationReject &)msg, ieIndex, bytes);
        break;
    case EMessageType::DEREGISTRATION_REQUEST_UE_ORIGINATING:
        CorruptViaMutator((DeRegistrationRequestUeOriginating &)msg, ieIndex, bytes);
        break;
    case EMessageType::DEREGISTRATION_ACCEPT_UE_ORIGINATING:
        CorruptViaMutator((DeRegistrationAcceptUeOriginating &)msg, ieIndex, bytes);
        break;
    case EMessageType::DEREGISTRATION_REQUEST_UE_TERMINATED:
        CorruptViaMutator((DeRegistrationRequestUeTerminated &)msg, ieIndex, bytes);
        break;
    case EMessageType::DEREGISTRATION_ACCEPT_UE_TERMINATED:
        CorruptViaMutator((DeRegistrationAcceptUeTerminated &)msg, ieIndex, bytes);
        break;
    case EMessageType::SERVICE_REQUEST:
        CorruptViaMutator((ServiceRequest &)msg, ieIndex, bytes);
        break;
    case EMessageType::SERVICE_REJECT:
        CorruptViaMutator((ServiceReject &)msg, ieIndex, bytes);
        break;
    case EMessageType::SERVICE_ACCEPT:
        CorruptViaMutator((ServiceAccept &)msg, ieIndex, bytes);
        break;
    case EMessageType::CONFIGURATION_UPDATE_COMMAND:
        CorruptViaMutator((ConfigurationUpdateCommand &)msg, ieIndex, bytes);
        break;
    case EMessageType::CONFIGURATION_UPDATE_COMPLETE:
        CorruptViaMutator((ConfigurationUpdateComplete &)msg, ieIndex, bytes);
        break;
    case EMessageType::AUTHENTICATION_REQUEST:
        CorruptViaMutator((AuthenticationRequest &)msg, ieIndex, bytes);
        break;
    case EMessageType::AUTHENTICATION_RESPONSE:
        CorruptViaMutator((AuthenticationResponse &)msg, ieIndex, bytes);
        break;
    case EMessageType::AUTHENTICATION_REJECT:
        CorruptViaMutator((AuthenticationReject &)msg, ieIndex, bytes);
        break;
    case EMessageType::AUTHENTICATION_FAILURE:
        CorruptViaMutator((AuthenticationFailure &)msg, ieIndex, bytes);
        break;
    case EMessageType::AUTHENTICATION_RESULT:
        CorruptViaMutator((AuthenticationResult &)msg, ieIndex, bytes);
        break;
    case EMessageType::IDENTITY_REQUEST:
        CorruptViaMutator((IdentityRequest &)msg, ieIndex, bytes);
        break;
    case EMessageType::IDENTITY_RESPONSE:
        CorruptViaMutator((IdentityResponse &)msg, ieIndex, bytes);
        break;
    case EMessageType::SECURITY_MODE_COMMAND:
        CorruptViaMutator((SecurityModeCommand &)msg, ieIndex, bytes);
        break;
    case EMessageType::SECURITY_MODE_COMPLETE:
        CorruptViaMutator((SecurityModeComplete &)msg, ieIndex, bytes);
        break;
    case EMessageType::SECURITY_MODE_REJECT:
        CorruptViaMutator((SecurityModeReject &)msg, ieIndex, bytes);
        break;
    case EMessageType::FIVEG_MM_STATUS:
        CorruptViaMutator((FiveGMmStatus &)msg, ieIndex, bytes);
        break;
    case EMessageType::NOTIFICATION:
        CorruptViaMutator((Notification &)msg, ieIndex, bytes);
        break;
    case EMessageType::NOTIFICATION_RESPONSE:
        CorruptViaMutator((NotificationResponse &)msg, ieIndex, bytes);
        break;
    case EMessageType::UL_NAS_TRANSPORT:
        CorruptViaMutator((UlNasTransport &)msg, ieIndex, bytes);
        break;
    case EMessageType::DL_NAS_TRANSPORT:
        CorruptViaMutator((DlNasTransport &)msg, ieIndex, bytes);
        break;
    default:
        throw std::runtime_error("invalid NAS message type");
    }
...
void CorruptNasMessage(const NasMessage &msg, int ieIndex, const OctetString &bytes)
{
    if (msg.epd == EExtendedProtocolDiscriminator::MOBILITY_MANAGEMENT_MESSAGES)
    {
        auto &mm = (MmMessage &)msg;
        CorruptMm((PlainMmMessage &)mm, ieIndex, bytes);
    }
    else
        CorruptSm((SmMessage &)msg, ieIndex, bytes);
}
